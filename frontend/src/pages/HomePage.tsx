...
const HomePage: React.FC = () => {
  ...
  // ✅ Helper to save scroll before navigation
  const saveScrollPosition = () => {
    const main = document.getElementById("main-content");
    if (main) {
      sessionStorage.setItem("HOME_SCROLL", main.scrollTop.toString());
    }
  };
  ...
  useLayoutEffect(() => {
    ...
    if (main) {
      ...
      // Attempt 2: Short delay (for images/layout)
  ...
  const legalDomains = [
    ...
    },
    {
      ...
      description:
        "Legal aspects of consumer protection, rights, and remedies.",
  ...
  const quickGuides = [
    ...
    {
      title: "Learn How Law Applies in a Situation",
      description:
        "Outline a situation to see how Indian law generally addresses such matters.",
    },
  ];
          ...
          <div className="relative max-w-2xl mx-auto mb-12">
            ...
            <input
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter") {
                  saveScrollPosition();
                  navigate("/home/library", { state: { query: searchQuery } });
                }
              }}
      ...
      <section className="bg-[#E6F3FF] py-20 px-4 w-full relative overflow-hidden">
        ...
        <div className="max-w-[1100px] mx-auto relative z-10 flex flex-col items-center">
          ...
          <button
            ...
            className="bg-white text-[#258CF4] hover:text-[#197DCA] px-8 py-3 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-10">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2 text-[14px]">
                ...
                <a className="text-[#323743] hover:text-[#197DCA]">
                  Legal Forms
                </a>
                <a className="text-[#323743] hover:text-[#197DCA]">
                  Legal News
